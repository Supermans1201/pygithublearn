import os
import re
os.remove('F:/LM/pygithub_leran/text8/diff_button_text')

button_diff=open('F:/LM/pygithub_leran/text8/diff_button_text', 'a')
        ...
        if start==False:
            ...
            if line.startswith("+") or line.startswith("-"):
                if not (line.startswith("+++") or line.startswith("---")):
                    ...
                    if re.search("button",newline,re.I):
                        print newline
                        button_diff.write(newline)
            # print line
