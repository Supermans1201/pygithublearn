import os
import re
os.remove('F:/LM/pygithub_leran/text8/diff_activity_text')

activity_diff=open('F:/LM/pygithub_leran/text8/diff_activity_text','a')
